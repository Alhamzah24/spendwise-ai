  ...
  return (
    <aside className="w-20 lg:w-72 bg-white h-full flex flex-col border-r border-slate-200 transition-all duration-300 z-50">
      ...
      <div className="p-6 mt-auto">
        <button className="w-full flex items-center gap-4 p-4 text-slate-400 hover:text-red-400 transition-colors border-t border-slate-200 pt-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden group">
             ...
             {reportError && !isAnalyzing && (
                 <div className="mt-8 p-6 bg-red-50 border border-red-500/30 rounded-2xl animate-fade-in flex items-center gap-4">
  ...
  return (
    <div className="p-10 max-w-7xl mx-auto space-y-12 animate-fade-in pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-10">
        ...
        <div className="flex items-center gap-4 bg-white/50 backdrop-blur-xl border border-slate-200 rounded-3xl p-2 shadow-2xl">
        ...
        <div className="lg:col-span-8 space-y-12">
          <div className="bg-white border border-slate-200 rounded-[4rem] p-12 space-y-12 shadow-3xl relative overflow-hidden group/main">
             ...
             <div className="flex justify-between items-center relative z-10">
                <div className="flex items-center gap-6">
                   <div className="w-16 h-16 bg-gradient-to-br from-amber-500/20 to-amber-600/5 rounded-3xl flex items-center justify-center border border-amber-300 shadow-2xl shadow-amber-200 group-hover/main:rotate-6 transition-transform">
